...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='buyer',
            name='market_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tag_feedback_input.market'),
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('feedback_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tag_feedback_input.feedback')),
            ],
        ),
        migrations.CreateModel(
            name='FollowUp',
            fields=[
                ...
                ('follow_up_date', models.DateField(blank=True, default=datetime.date(2024, 7, 31))),
